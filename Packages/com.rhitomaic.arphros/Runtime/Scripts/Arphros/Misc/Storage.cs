...
namespace ArphrosFramework {
    /// <summary>
    /// A file system wrapper for Arphros as it may contain abstraction for platform specific code.
    /// I also don't want to keep putting System.IO everywhere I go
    /// </summary>
    public static class Storage {
        private static string p_dataPath = UnityEngine.Application.persistentDataPath;
        public static string dataPath {
            get => p_dataPath;
            set => p_dataPath = value;
        }
        ...
        public static void CopyDirectoryLocal(string from, string to) => CopyDirectory(GetPathLocal(from), GetPathLocal(to));
        public static void CopyDirectory(string from, string to) => FileBrowserHelpers.CopyDirectory(from, to);
